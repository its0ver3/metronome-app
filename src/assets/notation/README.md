...
`gapGlyphs.js` also extracts the whole-bar, quarter, eighth, sixteenth, thirty-second, and sixty-fourth
rests, upward flags, and the half-note head from Bravura for the Gap Trainer. The
...
and sixty-fourth notes. For /16, they use sixteenth through 128th notes;
for /2, half through sixteenth notes. Other counts use N:2, N:4, or N:8 tuplets. These indicate
